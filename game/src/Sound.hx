...
class Sound{
	public static inline function shoot(){
		//ZzFX.zzfx(1.25,.05,691,.01,.05,.04,3,1.48,-4.2,0,0,0,0,0,0,0,.02,.86,.05,0);
	...
	public static inline function laser(){
		ZzFX.zzfx(1.99,.05,152,0,.19,.05,3,.62,52,0,0,0,0,0,215,0,.23,1,0,.05);
	}
	...
	public static inline function playerExplode(){
		ZzFX.zzfx(1.28,.05,606,0,.39,.96,3,2.6,0,0,0,0,0,.7,0,.8,.18,.89,0,.06);
	}
}